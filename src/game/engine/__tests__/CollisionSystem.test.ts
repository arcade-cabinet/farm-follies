...
import type { AnimalState, PlayerState, BushState } from '../state/GameState';
...
describe('CollisionSystem', () => {
  ...
  describe('calculateMagneticPull', () => {
    it('should pull entity toward player', () => {
      const entity = { 
        id: 'e1', x: 0, y: 0, width: 50, height: 50, 
        velocityX: 0, velocityY: 0, rotation: 0, scale: 1, active: true 
      };
      const player = { 
        id: 'player', x: 100, y: 100, width: 80, height: 100,
        velocityX: 0, velocityY: 0, rotation: 0, scale: 1, active: true,
        stackedAnimals: [], isInvincible: false, invincibilityTimer: 0,
        magnetActive: true, magnetTimer: 5000, doublePointsActive: false, doublePointsTimer: 0
      };
    ...
    it('should return zero pull when very close', () => {
      ...
      const entity = { 
        id: 'e1', x: 115, y: 125, width: 50, height: 50,
        velocityX: 0, velocityY: 0, rotation: 0, scale: 1, active: true
      };
      const player = { 
        id: 'player', x: 100, y: 100, width: 80, height: 100,
  ...
  describe('getStackTopPosition', () => {
    ...
    it('should return elevated position with stacked animals', () => {
      ...
      const stackedAnimals: AnimalState[] = [
        {
          id: 'a1', type: 'chicken', variant: 'white',
          x: 100, y: 350, width: 50, height: 50,
          velocityX: 0, velocityY: 0, rotation: 0, scale: 1,
          active: true, isCaught: true, stackIndex: 0,
          wobblePhase: 0, wobbleAmplitude: 0,
          specialAbilityReady: false, specialAbilityCooldown: 0,
        },
      ];
